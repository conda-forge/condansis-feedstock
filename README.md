...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/condansis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12571&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/condansis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `condansis` can be installed with:

```
conda install condansis
```

It is possible to list all of the versions of `condansis` available on your platform with:
